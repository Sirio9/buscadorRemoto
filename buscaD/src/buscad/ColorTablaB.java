...
/**
 *
 * @author MURACHI DOMESA
 */
public class ColorTablaB extends DefaultTableCellRenderer{
      
    @SuppressWarnings("CastConflictsWithInstanceof")
    public ColorTablaB getTableCellRendererComponent(JTable jtable, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
